...
Your Shell should:
*   Display a shell_prompt and wait for the user to type a command. A command line always ends with a new line.
*   The shell_prompt is displayed again each time a command has been executed.
*   The command lines are simple, no semicolons, no pipes, no redirections or any other advanced features.
*   The command lines are made only of one word. No arguments will be passed to programs.
*   If an executable cannot be found, print an error message and display the shell_prompt again.
*   Handle errors.
...
---
Simple shell 1.0 +
*   Handle the commands shell_splitter `;`.
- - -
...
*   In this mode, the shell should not print a shell_prompt and should not read from `stdin`.
- - -
