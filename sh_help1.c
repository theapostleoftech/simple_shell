...
/**
 * sh_help_all - Displays all possible builtin shellby commands
 */
void sh_help_all(void)
{
	...
	msg = "Type 'sh_help' to see this list.\nType 'sh_help name' to find ";
	write(STDOUT_FILENO, msg, sh_strlen(msg));
...
/**
 * sh_help_alias - Displays information on the shell by builtin command 'alias'
 */
void sh_help_alias(void)
{
	...
	write(STDOUT_FILENO, msg, sh_strlen(msg));
	msg = "is already an alias, replace its val with VALUE.\n";
	write(STDOUT_FILENO, msg, sh_strlen(msg));
}

/**
 * sh_help_cd - Displays information on the shell by builtin command 'cd'
 */
...
/**
 * sh_help_exit - Displays information on the shell by builtin command 'exit'
 */
