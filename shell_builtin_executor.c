 ...
 * Return: Always 0
 */
int shell_env(__attribute__((unused)) char **cmd, __attribute__((unused)) int st)
{
	size_t i;
	int len;
...
/**
 * shell_history - display history of user input
 * @c: parsed command
 * @st: status of last command executed
 * Return: 0 success or -1 if fail
 */
int shell_history(__attribute__((unused))char **c, __attribute__((unused))int st)
{
